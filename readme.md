# HDI_ExtractPDFattachments

Extract attachments from a PDF/A3 file (4D 20 R6)

Find more information on the [blog post](https://blog.4d.com/pdf-a3-file-extraction/).
